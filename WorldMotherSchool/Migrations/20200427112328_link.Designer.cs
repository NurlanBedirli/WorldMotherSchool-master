...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorldMotherSchool.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WorldMotherSchool.Models.EventAboutLanguage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("EventAboutId");
                    ...
                    b.HasIndex("EventAboutId");

                    b.HasIndex("LanguageId");

                    b.ToTable("EventAboutLanguages");
                });

            modelBuilder.Entity("WorldMotherSchool.Models.EventAboutPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("WorldMotherSchool.Models.MainContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WorldMotherSchool.Models.AppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("WorldMotherSchool.Models.EventAboutLanguage", b =>
                {
                    b.HasOne("WorldMotherSchool.Models.EventAbout", "EventAbout")
                        .WithMany("EventAboutLanguages")
                        .HasForeignKey("EventAboutId")
                        .OnDelete(DeleteBehavior.Cascade);
